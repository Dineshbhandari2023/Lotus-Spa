...
const therapiesData = {
  ayurvedic: {
    EN: {
      ...
      prep: ["Avoid heavy meals 1 hour before.", "Arrive 15 minutes early to adjust to the temperature."],
      benefits: ["Aligns natural sleep cycles", "Balances physical doshas", "Improves scalp and skin nutrition"]
    },
    NP: {
      ...
      duration: "९० मिनेट",
      image: "/images/spa_ayurvedic_treatment.png",
      prep: ["उपचारको १ घण्टा पहिले भारी खाना नखानुहोस्।", "शान्त वातावरणमा घुलमिल हुन १५ मिनेट पहिले आउनुहोस्।"],
      benefits: ["प्राकृतिक निद्राको चक्र सुधार गर्छ", "शारीरिक दोषहरू सन्तुलन गर्छ", "छाला र कपालको स्वास्थ्य राम्रो बनाउँछ"]
    }
  },
  "deep-tissue": {
    EN: {
      ...
      prep: ["Drink plenty of water prior to the session.", "Communicate your pressure preferences with your practitioner."],
      benefits: ["Alleviates chronic back and neck pain", "Releases deep inflammatory muscle knots", "Improves overall posture"]
    },
    NP: {
      ...
      image: "https://picsum.photos/seed/massage/1200/800",
      prep: ["थेरापी अगाडि प्रशस्त पानी पिउनुहोस्।", "आफ्नो सहजता अनुसारको दबाबको बारेमा थेरापिस्टसँग सल्लाह गर्नुहोस्।"],
      benefits: ["ढाड र घाँटीको पुरानो दुखाइ निको पार्छ", "मांसपेशीका गाँठाहरू खुलाउँछ", "शारीरिक ढाँचा वा पोस्चर सुधार गर्छ"]
    }
  },
  "thai-stretch": {
    EN: {
      ...
      prep: ["Wear loose, comfortable clothing.", "Be prepared for gentle, assisted stretching maneuvers."],
      benefits: ["Enhances athletic range of motion", "Stretches spine and joints fully", "Boosts active circulation flow"]
    },
    NP: {
      title: "थाई स्ट्रेचिङ",
      ...
      duration: "६० मिनेट",
      image: "https://picsum.photos/seed/thai/1200/800",
      prep: ["खुकुलो र सजिलो कपडा लगाउनुहोस्।", "योगासन शैलीको स्ट्रेचिङका लागि तयार हुनुहोस्।"],
      benefits: ["शारीरिक लचिलोपन थप गर्छ", "मेरुदण्ड र जोर्नीहरूलाई खुकुलो बनाउँछ", "सक्रिय रक्तसञ्चार बढाउँछ"]
    }
  },
  "hot-stone": {
    EN: {
      ...
      prep: ["Avoid sunbathing or microdermabrasion before your session.", "Warm thermal heat can cause sweating; hydration is key."],
      benefits: ["Deeply calms nervous system irritation", "Fosters intense thermal muscle relaxation", "Detoxifies cellular metabolic pathways"]
    },
    NP: {
      ...
      duration: "९० मिनेट",
      image: "https://picsum.photos/seed/stones/1200/800",
      prep: ["थेरापी अगाडि कडा घाममा नबस्नुहोस्।", "तातो बाफले पसिना निकाल्ने हुँदा पर्याप्त पानी पिउनुहोस्।"],
      benefits: ["स्नायु प्रणालीलाई शान्त बनाउँछ", "मांसपेशीलाई गहिरो आराम दिन्छ", "शारीरिक विषालु तत्वहरू बाहिर फाल्न मद्दत गर्छ"]
    }
  },
  "organic-facial": {
    EN: {
      ...
      prep: ["Inform your therapist of skin allergies or chemical treatments.", "Avoid shaving immediately before the facial session."],
      benefits: ["Restores skin moisture barrier cleanly", "Brightens complexion with natural saffron", "Reduces environmental oxidative stress"]
    },
    NP: {
      title: "लोटस फेसियल",
      ...
      duration: "६० मिनेट",
      image: "https://picsum.photos/seed/facial/1200/800",
      prep: ["कुनै एलर्जी वा पहिलेको छाला उपचारबारे पहिले जानकारी दिनुहोस्।", "फेसियल गर्नु अगाडि दाह्री नकाट्नुहोस्।"],
      benefits: ["छालाको प्राकृतिक ओसिलोपन फर्काउँछ", "केसरको गुणले अनुहार चम्किलो बनाउँछ", "धुलो र प्रदूषणको नकारात्मक असर कम गर्छ"]
    }
  },
  "steam-sauna": {
    EN: {
      ...
      prep: ["Remove jewelry and metallic watches.", "Cool down for 5 minutes prior to bathing in cold water."],
      benefits: ["Expels stored biological toxins through sweat", "Relieves congestion and improves breathing", "Softens and purifies skin outer layers"]
    },
    NP: {
      title: "स्टीम र साउना",
      ...
      image: "https://picsum.photos/seed/steam/1200/800",
      prep: ["सुनका गहना र धातुका घडी फुकाल्नुहोस्।", "साउनापछि चिसो पानीले नुहाउनु अघि ५ मिनेट शरीर चिसो हुन दिनुहोस्।"],
      benefits: ["पसिनाको माध्यमबाट शरीरको फोहोर बाहिर फाल्छ", "श्वासप्रश्वास प्रणाली सफा गर्छ", "छालालाई नरम र चम्किलो बनाउँछ"]
    }
  }
};
...
export default function TherapyPage() {
  ...
  const therapy = therapiesData[slug as keyof typeof therapiesData] || therapiesData.ayurvedic;
  ...
  return (
    <div className={`min-h-screen font-sans transition-colors duration-300 ${
      ...
      <header className={`sticky top-0 z-50 border-b backdrop-blur-md transition-colors ${
        theme === "dark" ? "bg-[#121510]/95 border-[#272F22]" : "bg-[#FDFBF7]/95 border-[#E5DED4]"
      }`}>
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className={`flex items-center gap-2 px-3 py-1.5 text-[10px] font-black uppercase tracking-widest transition-all border ${
                theme === "dark" ? "bg-[#1A1F16] border-[#272F22] hover:border-[#7C8461]" : "bg-white border-[#E5DED4] hover:bg-[#F8F6F2]"
              }`}
            >
            ...
            <button
              ...
              className={`p-2 border transition-all ${
                theme === "dark" ? "bg-[#1A1F16] border-[#272F22] text-[#7C8461]" : "bg-white border-[#E5DED4] text-[#2D2D2D]"
              }`}
            >
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="lg:col-span-6 space-y-6">
            <motion.div 
              ...
              className={`inline-flex items-center gap-2 px-3 py-1.5 text-[10px] font-bold uppercase tracking-[0.2em] border ${
                theme === "dark" ? "bg-[#1A1F16] border-[#7C8461]/40 text-[#7C8461]" : "bg-[#F8F6F2] border-[#E5DED4] text-[#7C8461]"
              }`}
            >
            ...
            <motion.div 
              ...
              className={`grid grid-cols-2 gap-4 p-5 border ${
                theme === "dark" ? "bg-[#1A1F16] border-[#272F22]" : "bg-[#F8F6F2] border-[#E5DED4]"
              }`}
            >
            ...
            >
              ...
              >
                ...
                <span>{currentLang === "EN" ? "Book This Treatment" : "यो थेरापी बुक गर्नुहोस्"}</span>
              </button>
            </motion.div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mt-20 pt-16 border-t border-dashed border-[#E5DED4] dark:border-[#272F22]">
          ...
          <div className="space-y-6">
            <h3 className="text-lg font-black uppercase tracking-wider text-[#7C8461]">
              {currentLang === "EN" ? "Appointment Preparation" : "पूर्व तयारी नियम"}
            </h3>
            <div className="space-y-4">
              {content.prep.map((rule, rIdx) => (
                <div key={rIdx} className={`p-4 border font-semibold text-xs sm:text-sm ${
                  theme === "dark" ? "bg-[#1A1F16]/40 border-[#272F22]" : "bg-white border-[#E5DED4]"
                }`}>
                  <div className="text-[10px] font-black uppercase tracking-widest text-[#7C8461] mb-1">
                    {currentLang === "EN" ? `Guideline 0${rIdx + 1}` : `नियम ०${rIdx + 1}`}
                  </div>
