...
import { Flower, Facebook, Phone, Compass, Copyright, ShieldCheck, Heart } from 'lucide-react';
  ...
  return (
    <footer 
      ...
      className={`border-t py-16 transition-colors duration-300 relative ${
        theme === 'dark' ? 'bg-[#121510] text-[#A2A994] border-[#272F22]' : 'bg-[#FDFBF7] text-[#666] border-[#E5DED4]'
      }`}
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start mb-12 text-sm">
          ...
          <div className="md:col-span-5 space-y-5">
            <div className="flex items-center gap-2.5">
              ...
              <span className={`font-serif font-semibold text-lg tracking-wide ${theme === 'dark' ? 'text-white' : 'text-[#2D2D2D]'}`}>
                {t.brandName}
              </span>
            </div>
          ...
          <div className="md:col-span-3 space-y-4">
            <h4 className={`font-sans font-bold uppercase text-[10px] tracking-[0.2em] ${
              theme === 'dark' ? 'text-white' : 'text-[#2D2D2D]'
            }`}>
              {currentLang === 'EN' ? 'Holistic Therapies' : 'हाम्रा सेवाहरू'}
            </h4>
            <ul className="space-y-2.5 text-xs font-sans">
              <li><a href="#services-section" className="hover:text-[#7C8461] transition-colors block">Ayurvedic Shirodhara</a></li>
              <li><a href="#services-section" className="hover:text-[#7C8461] transition-colors block">Deep Tissue Massage</a></li>
              <li><a href="#services-section" className="hover:text-[#7C8461] transition-colors block">Traditional Thai Massage</a></li>
              <li><a href="#services-section" className="hover:text-[#7C8461] transition-colors block">Pine Sauna & Eucalyptus Steam</a></li>
            </ul>
          </div>
          ...
          <div className="md:col-span-4 space-y-4">
            <h4 className={`font-sans font-bold uppercase text-[10px] tracking-[0.2em] ${
              ...
              {currentLang === 'EN' ? 'Official Channels' : 'आधिकारिक च्यानलहरू'}
            </h4>
            ...
            <div className="flex flex-col gap-3 text-xs">
              ...
              >
                ...
                <div className="font-sans">
                  ...
                  <p className="text-[10px] opacity-75">Connect, review deals & photos</p>
                </div>
              </a>
              ...
              >
                ...
                <div className="font-sans">
                  ...
                  <p className="text-[10px] opacity-75">Navigate route from Dharan Road</p>
                </div>
              </a>
        ...
        <div className="pt-8 mt-8 border-t border-[#E5DED4]/60 dark:border-[#272F22]/60 flex flex-col sm:flex-row justify-between items-center gap-4 text-[11px] font-sans">
          ...
          <div className="flex items-center gap-1 opacity-80">
            ...
            <span>2026 {t.brandName}. All rights reserved. Registered in Nepal.</span>
          </div>

          <div className="flex items-center gap-4 font-semibold">
            <span className="flex items-center gap-1 text-[#7C8461]">
              <ShieldCheck className="w-3.5 h-3.5" />
              <span>{currentLang === 'EN' ? 'Govt Certified' : 'प्रमाणित स्पा केन्द्र'}</span>
            </span>
