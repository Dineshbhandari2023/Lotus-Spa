...
export default function Hero({ currentLang, theme }: HeroProps) {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-4 relative z-10 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center text-left space-y-8">
            ...
            <motion.h1
              ...
              className="text-6xl sm:text-5xl lg:text-6xl font-montserrat font-semibold leading-tight tracking-[0.02em]"
            >
              {currentLang === "EN" ? (
                <>
                  Sanctuary of <br />
            ...
            <motion.p
              ...
              className={`text-sm, sm:text-base leading-relaxed max-w-xl font-montserrat ${
