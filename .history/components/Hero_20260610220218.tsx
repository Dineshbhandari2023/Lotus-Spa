  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none overflow-hidden">
        <div className={`w-[450px] h-[450px] border rounded-full flex items-center justify-center opacity-30 ${
          theme === 'dark' ? 'border-[#7C8461]/20' : 'border-[#E5DED4]'
        }`}>
          <div className={`w-[300px] h-[300px] border rounded-full ${
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center text-left space-y-8">
            ...
            >
              {currentLang === 'EN' ? (
                <>
                  Sanctuary of <br/>
                  <span className="italic font-normal text-[#7C8461]">Inner Harmony</span> & Polish
                </>
              ) : (
                <>
                  मस्तिष्क र शरीरको <br/>
                  <span className="italic font-normal text-[#7C8461]">वास्तविक सन्तुलन</span>
                </>
              )}
            </motion.h1>
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] font-bold font-sans tracking-[0.15em] uppercase opacity-80">
                  {currentLang === 'EN' ? 'Ayurvedic Excellence' : 'आयुर्वेदिक विशेषज्ञता'}
                </span>
              </div>
              <div className="flex items-center gap-2">
                <MapPin className="w-4 h-4 text-[#7C8461]" />
                <span className="text-[10px] font-bold font-sans tracking-[0.15em] uppercase opacity-80">
                  {currentLang === 'EN' ? '4 Eastern Branches' : '४ पूर्व शाखाहरू'}
                </span>
              </div>
            </motion.div>
          ...
          >
            <div className={`p-4 rounded-none border ${
              theme === 'dark' ? 'bg-[#1A1F16]/60 border-[#272F22]' : 'bg-white border-[#E5DED4]'
            }`}>
              ...
              <div className={`p-4 mt-4 rounded-none flex items-center justify-between text-[9px] font-sans uppercase tracking-[0.15em] ${
                theme === 'dark' ? 'bg-[#121510]/80 text-[#A2A994]' : 'bg-[#F8F6F2] text-[#555]'
              }`}>
                <span>{currentLang === 'EN' ? 'Hygienic Cabins' : 'स्वच्छ क्याबिन'}</span>
                <span className="text-[#7C8461] font-bold">•</span>
                <span>{currentLang === 'EN' ? 'Organic Herbs' : 'जैविक जडीबुटी'}</span>
                <span className="text-[#7C8461] font-bold">•</span>
