...
export const translations: Record<"EN" | "NP", TranslationSet> = {
  EN: {
    ...
    heroSubheadline:
      "Nepal's premier luxury wellness brand offering authentic Ayurvedic arts, deep tissue therapy, and soothing aroma-baths across East Nepal's leading cities.",
  ...
  NP: {
    ...
    heroSubheadline:
      "नेपालको अग्रणी लक्जरी वेलनेस ब्रान्ड जसले पूर्वी नेपालका प्रमुख शहरहरूमा वास्तविक आयुर्वेदिक कला, गहिरो तन्तु थेरापी, र सुगन्धित बाथ सेवाहरू प्रदान गर्दछ।",
