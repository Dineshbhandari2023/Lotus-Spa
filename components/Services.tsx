...
import { Flower, Timer } from "lucide-react";
  ...
  const mainServices = [
    {
      ...
      features:
        currentLang === "EN"
          ? [
              "Warm herbal oil stream",
              "Aligns Prana energy",
              "Relieves neurological stress",
            ]
          : [
              "मनतातो जडीबुटी तेल",
              "प्राण उर्जा सन्तुलन",
      ...
      features:
        currentLang === "EN"
          ? [
              ...
              "Targets deep muscle knots",
              "Improves body pressure rhythm",
            ]
          : [
              "ढाडको पुरानो दुखाइ निको",
              "तन्तुहरूको भित्री तहसम्म स्पर्श",
              "रक्तसंचार प्रवाह",
            ],
    },
    {
      ...
      features:
        currentLang === "EN"
          ? [
              ...
              "Acubending & stretching",
              "Enhances physical flexibility",
            ]
          : [
              "कपडा नलगाई, बिना तेल थेरापी",
              "योगासन जस्तै स्ट्रेचिङ",
              "लचिलोपन थप्ने",
            ],
    },
    {
      ...
      features:
        currentLang === "EN"
          ? [
              "Heated basalt volcanic stones",
              "Soothing deep spinal warmth",
              "Detoxifies metabolic pathways",
            ]
          : [
              "तातो ज्वालामुखी ढुङ्गाहरू",
              "ढाडको मेरुदण्ड तातो बनाउने",
              "शारीरिक विष फाल्ने",
            ],
    },
    {
      ...
      features:
        currentLang === "EN"
          ? [
              "Fresh organic lotus honey",
              "Saffron cellular restore",
              "Deep exfoliating extraction",
            ]
          : [
              "ताजा अर्गानिक मह र लोटस",
              "केसर र वनस्पती प्याक",
              "छालाको गहिरो सफाइ",
            ],
    },
    {
      ...
      features:
        currentLang === "EN"
          ? [
              "Infused Himalayan eucalyptus",
              "Detoxifies lung & sinuses",
              "Opens skin pores fully",
            ]
          : [
              "हिमाली युकालिप्टस बाफ",
              "फोक्सो र श्वासप्रश्वास सफा",
              "छालाका छिद्र खुला पार्ने",
            ],
    },
  ];
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Bento Grid with Sharp Corporate Framing */}
          ...
          {mainServices.map((service, index) => (
            ...
            >
              ...
              <div className="relative aspect-[4:3] overflow-hidden bg-stone-100 rounded-none">
                <img
                  src={service.image}
                  alt={`${service.title} - Lotus Spa Nepal`}
                ...
                {/* Float Badge */}
                <span className="absolute top-4 left-4 bg-[#7C8461] text-white text-[9px] font-bold uppercase tracking-[0.2em] px-3 py-1.5 rounded-none">
                  {service.badge}
                </span>
                ...
                <div className="absolute bottom-4 left-4 right-4 flex items-end justify-between">
                  ...
                  <span className="inline-flex items-center gap-1.5 text-[9px] font-bold text-white bg-[#121510]/95 px-2.5 py-1.5 rounded-none border border-[#7C8461]/30 tracking-wider uppercase">
              ...
              <div className="p-6 flex flex-col flex-grow space-y-4">
                <h3
                  className={`text-base font-bold uppercase tracking-wide group-hover:text-[#7C8461] transition-colors ${
                ...
                <p
                  className={`text-xs sm:text-sm leading-relaxed flex-grow line-clamp-3 font-medium ${
                ...
                <div className="space-y-2.5 pt-4 border-t border-[#E5DED4] dark:border-[#272F22]">
                  {service.features.map((feat, fIdx) => (
                    ...
                    >
                      ...
                      <span
                        className={
                          theme === "dark" ? "text-[#DCE0D4]" : "text-[#444]"
                        }
                      >
                        {feat}
                      </span>
                ...
                <div className="pt-2">
                  <a
                    ...
                    className="inline-flex items-center gap-1.5 text-[10px] font-bold uppercase tracking-[0.15em] text-[#7C8461] hover:text-[#6b7352] transition-colors"
                  >
                    <span>
                      {currentLang === "EN"
                        ? "Configure Therapy"
